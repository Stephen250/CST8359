<%@ Page Title="Edit Product" Language="C#" MasterPageFile="~/SiteAdminMenu.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="CST8359_Assignment2.Admin.EditProduct" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        <asp:Button runat="server" OnClick="UpdateProduct_Click" Text="Update" CssClass="btn btn-default" />
