<%@ Page Title="Request" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Request.aspx.cs" Inherits="CST8359_Lab6.Request" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        <div class="col-md-offset-2 col-md-10">
            <asp:Button ID="Button1" runat="server" class="btn btn-default" Text="Pass to RequestDisplay" OnClick="button1_click" />
        </div>
    </div>
    <hr />
</asp:Content>
