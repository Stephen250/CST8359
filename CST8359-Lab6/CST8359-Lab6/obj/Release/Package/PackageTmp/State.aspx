<%@ Page Title="State" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="State.aspx.cs" Inherits="CST8359_Lab6.State" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        <div class="col-md-offset-2 col-md-10">
            <asp:Button ID="Button1" runat="server" class="btn btn-default" Text="Pass to StateDisplay" OnClick="button1_click" />
        </div>
    </div>
    <hr />
</asp:Content>
